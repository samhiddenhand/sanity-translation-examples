...
var PublishWithi18nAction = function PublishWithi18nAction(props) {
  ...
  var _useValidationStatus = reactHooks.useValidationStatus(props.id, props.type),
  ...
  return {
    disabled: publishing || publish.disabled || syncState.isSyncing || isValidating || markers.some(function (marker) {
    ...
    onHandle: function () {
      var _onHandle = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee() {
        ...
        var client, fieldName, refsFieldName, langs, languageId, saveTransaction, translatedDocuments, basedocTransaction;
        return _regeneratorRuntime__default['default'].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 6:
                ...
                saveTransaction.createIfNotExists({
                  _id: props.id,
                  _type: props.type,
                  _createdAt: moment().utc().toISOString()
                });
                saveTransaction.patch(((_props$draft = props.draft) === null || _props$draft === void 0 ? void 0 : _props$draft._id) || props.id, {
                  set: _defineProperty__default['default']({}, fieldName, languageId)
                });
                _context.next = 13;
                return saveTransaction.commit();
              ...
              case 16:
                ...
                basedocTransaction = client.transaction();
                basedocTransaction.createIfNotExists({
                  _id: baseDocumentId,
                  _type: props.type,
                  _createdAt: moment().utc().toISOString()
                });
                ...
                _context.next = 23;
                return basedocTransaction.commit();
