...
var Input = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Input() {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "_firstField", void 0);
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "setFirstField", function (el) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "handleFieldChange", function (fieldEvent, field) {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "renderField", function (field, level, index) {
      var currentLanguage = _this.state.currentLanguage;
      ...
      if (currentLanguage) {
        ...
        return /*#__PURE__*/React.createElement(Field__default['default'], {
          ...
          ref: index === 0 ? _this.setFirstField : undefined
        });
      }
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "renderFieldset", function (fieldset, fieldsetIndex) {
      ...
      var collapsibleOpts = getCollapsedWithDefaults(fieldset.options, level !== null && level !== void 0 ? level : 0);
      var isExpanded = focusPath && focusPath.length > 0 && fieldset.fields.some(function (field) {
        return focusPath[0] === field.name;
      });
      var fieldNames = fieldset.fields.map(function (f) {
        return f.name;
      });
      var childPresence = presence.length === 0 ? presence : presence.filter(function (item) {
        return fieldNames.includes(item.path[0]);
      });
      var childMarkers = markers ? markers.length === 0 ? markers : markers.filter(function (item) {
        return item.path && item.path[0] ? fieldNames.includes(String(item.path[0])) : false;
      }) : [];
      var isCollapsed = !isExpanded && collapsibleOpts.collapsed;
      return /*#__PURE__*/React.createElement("div", {
        key: fieldset.name,
        className: styles.fieldset
      }, /*#__PURE__*/React.createElement(Fieldset__default['default'], {
        legend: fieldset.title,
        description: fieldset.description,
        level: (level !== null && level !== void 0 ? level : 0) + 1,
        columns: columns,
        ...
        return _this.renderField(field, (level !== null && level !== void 0 ? level : 0) + 2, fieldsetIndex + fieldIndex);
      })));
    });

    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "getRenderedFields", function () {
      ...
      if (!type.fieldsets) {
        ...
        return (type.fields || []).map(function (field, i) {
          return _this.renderField(field, (level !== null && level !== void 0 ? level : 0) + 1, i);
        });
      }

      return type.fieldsets.map(function (fieldset, i) {
        return fieldset.single ? _this.renderField(fieldset.field, (level !== null && level !== void 0 ? level : 0) + 1, i) : _this.renderFieldset(fieldset, i);
      });
    });

    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "getRenderedObjectInput", function () {
      ...
      var renderedFields = _this.getRenderedFields();
      ...
      var collapsibleOpts = getCollapsedWithDefaults(type.options, level !== null && level !== void 0 ? level : 0);
      var isExpanded = focusPath && focusPath.length > 0;
      var columns = type.options && type.options.columns;
      var isCollapsed = !isExpanded && collapsibleOpts.collapsed;
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Fieldset__default['default'], {
        level: level,
        legend: type.title,
  ...
  _createClass__default['default'](Input, [{
    ...
    value: function focus() {
      var _this$_firstField;

      (_this$_firstField = this._firstField) === null || _this$_firstField === void 0 ? void 0 : _this$_firstField.focus();
    }
  }, {
    ...
    value: function render() {
      ...
      var renderedObjectInput = this.getRenderedObjectInput();
...
_defineProperty__default['default'](Input, "defaultProps", {
